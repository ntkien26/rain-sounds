...
import 'package:rain_sounds/common/utils/InterstitialAdManager.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: size.width * 0.65,
                              child: const Text(
                                'Watch a short video to get this premium mix until close app',
        ...
        } else if (widget.mix.premium == false && !appCache.isPremiumMember()) {
          adManager.checkAndShowAd(context, NowMixPlayingScreen(mix: widget.mix));
